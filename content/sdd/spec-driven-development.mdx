...
[Superpowers →](https://github.com/superpowers-ai/superpowers) brainstorm → plan → execute gates

[OpenSpec →](https://github.com/openspec/openspec) delta-spec for brownfield
